...
const libraryPath = path.join(
  ...
  process.platform === 'win32'
    ? 'ffi_test_library.dll'
    : process.platform === 'darwin'
      ? 'ffi_test_library.dylib'
      : 'ffi_test_library.so',
);
...
const fixtureSymbols = {
  ...
  call_string_return_callback_matches: { arguments: ['pointer', 'pointer'], return: 'i32' },
  call_void_callback: { arguments: ['pointer'], return: 'void' },
  string_survives_callback: { arguments: ['pointer', 'pointer'], return: 'i32' },
  ...
  sum_8_i32: { arguments: ['i32', 'i32', 'i32', 'i32', 'i32', 'i32', 'i32', 'i32'], return: 'i32' },
  sum_five_f64: { arguments: ['f64', 'f64', 'f64', 'f64', 'f64'], return: 'f64' },
  mixed_operation: { arguments: ['i32', 'f32', 'f64', 'u32'], return: 'f64' },
  allocate_memory: { arguments: [usize], return: 'pointer' },
  deallocate_memory: { arguments: ['pointer'], return: 'void' },
  array_get_i32: { arguments: ['pointer', usize], return: 'i32' },
  array_set_i32: { arguments: ['pointer', usize, 'i32'], return: 'void' },
  array_get_f64: { arguments: ['pointer', usize], return: 'f64' },
  array_set_f64: { arguments: ['pointer', usize, 'f64'], return: 'void' },
};
...
export { cString, fixtureSymbols, libraryPath, nativeSize };
